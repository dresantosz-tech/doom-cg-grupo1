...
struct RenderAssets
{
    GLuint texChao1 = 0, texChao2 = 0, texChao3 = 0, texChao4 = 0, texParede1 = 0, texParede2 = 0, texParede3 = 0, texPorta = 0, texSangue = 0, texLava = 0;
    GLuint texChaoInterno = 0, texParedeInterna = 0, texTeto = 0, texSkydome = 0, texSkydome2 = 0, texSkydome3 = 0, texMenuBG = 0, texEndBG = 0;
